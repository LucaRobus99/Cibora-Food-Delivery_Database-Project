...
1. 
**DDL:** Tables created with strict constraints (e.g., `CHECK` constraints for ratings between 1 and 5).


2. 
**DML:** Sample data for 3 restaurants, multiple users, and various delivery scenarios.


3. 
**Constraint Testing:** Verification of `ON DELETE CASCADE` and `SET NULL` behaviors when users or allergens are removed.
